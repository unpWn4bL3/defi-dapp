...
module suimarket::royalty_rule {
    ...
    use suimarket::merchantmarket::{Listing};
    ...
    public fun add(
        policy: &mut TransferPolicy<Listing>,
        cap: &TransferPolicyCap<Listing>,
        amount_bp: u16,
        min_amount: u64
    ) {
    ...
    public fun pay(
        policy: &mut TransferPolicy<Listing>,
        request: &mut TransferRequest<Listing>,
        payment: Coin<SUI>
    ) {
    ...
    public fun fee_amount(policy: &TransferPolicy<Listing>, paid: u64): u64 {
